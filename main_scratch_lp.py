...
model = vgg_lp(bits_A=32, bits_E=32, bits_W=32, dataset=args.dataset, depth=args.depth)
if args.scratch:
    checkpoint = torch.load(args.scratch)
    # model = models.__dict__[args.arch](dataset=args.dataset, depth=args.depth, cfg=checkpoint['cfg'])
    model = vgg_lp(bits_A=32, bits_E=32, bits_W=32, dataset=args.dataset, depth=args.depth, cfg=checkpoint['cfg'])
    # model_ref = models.__dict__[args.arch](dataset=args.dataset, depth=args.depth, cfg=checkpoint['cfg'])
    model_ref = vgg_lp(bits_A=8, bits_E=8, bits_W=8, dataset=args.dataset, depth=args.depth, cfg=checkpoint['cfg'])
    ...
    model_base = vgg_lp(bits_A=32, bits_E=32, bits_W=32, dataset=args.dataset, depth=args.depth)
